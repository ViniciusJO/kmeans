...
pub extern fn stbi_load_from_file(f: ?*FILE, x: [*c]c_int, y: [*c]c_int, channels_in_file: [*c]c_int, desired_channels: c_int) [*c]stbi_uc;
...
pub extern fn stbi_load_from_file_16(f: ?*FILE, x: [*c]c_int, y: [*c]c_int, channels_in_file: [*c]c_int, desired_channels: c_int) [*c]stbi_us;
...
pub extern fn stbi_loadf_from_file(f: ?*FILE, x: [*c]c_int, y: [*c]c_int, channels_in_file: [*c]c_int, desired_channels: c_int) [*c]f32;
...
pub extern fn stbi_is_hdr_from_file(f: ?*FILE) c_int;
...
pub extern fn stbi_info_from_file(f: ?*FILE, x: [*c]c_int, y: [*c]c_int, comp: [*c]c_int) c_int;
pub extern fn stbi_is_16_bit(filename: [*c]const u8) c_int;
pub extern fn stbi_is_16_bit_from_file(f: ?*FILE) c_int;
...
pub const STB_IMPLEMENTATION = @as(c_int, 1);
